...
<script>
  $(document).ready( function () {
    ...
    <title>Area de conocimiento</title>
</head>
<body>
    <?php 
...
<?php 
$sql4=$conexion->query("SELECT Area_Conocimiento as Area, COUNT(*) as Total FROM `colombianos_registrados_en_el_exterior_20240927`
...
<div class="contenedor_infor">
    <p>En el siguiente grafico podremos apreciar, información de la población colombiana. Residente y registrada en el exterior. En este caso la información mostrada por el grafico de abajo refleja la cantidad de colombianos registrados por areas de conocimiento.</p>
<div id="Grafico">
...
<div class="container">
  ...
  <tbody>
    <?php 
   $sql9=$conexion->query("SELECT Pais,Area_Conocimiento as Area, COUNT(*) as colombos FROM `colombianos_registrados_en_el_exterior_20240927`
GROUP by Pais,Area_Conocimiento order by colombos desc;");
