...
<?php 
$sql4=$conexion->query("SELECT Area_Conocimiento as Area, COUNT(*) as Total FROM `colombianos_exterior`
...
<div class="container">
  ...
  <tbody>
    <?php 
   $sql9=$conexion->query("SELECT Pais,Area_Conocimiento as Area, COUNT(*) as colombos FROM `colombianos_exterior`
